...
The profile highlights four projects. This index keeps the other public work easy to find without giving every experiment equal billing.

| Project | Place in the portfolio | Current scope |
| --- | --- | --- |
...
A successful deployment workflow is evidence of that workflow completing, not proof that every application feature works. A failed workflow is a repair signal, not a reason by itself to delete a project.

The profile artwork is vector cover art. Actual application screenshots can be added after the corresponding applications are available for capture.
